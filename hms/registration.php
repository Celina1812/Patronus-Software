...
if (isset($_POST['submit'])) {
	...
	if ($query) {
		echo "<script>alert('Tu registro ha sido exitoso. Ahora puedes iniciar sesión.');</script>";
...
<head>
	<title>Patronus | Registrarse</title>
			...
			<div class="box-register">
				<form name="registration" id="registration" method="post" onSubmit="return valid();">
					<fieldset>
						...
						<div class="form-group">
							<span class="input-icon">
								<input type="password" class="form-control" id="password_again" name="password_again" placeholder="Contraseña nuevamente" required>
								<i class="fa fa-lock"></i> </span>
						</div>
						<div class="form-group">
				...
				<div class="copyright">
					&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> PS</span>. <span>Todos los derechos reservados</span>
				</div>
