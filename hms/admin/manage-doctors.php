			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Ordenes completadas</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Ordenes</span>
					...
					<div class="container-fluid container-fullw bg-white">
						<div class="row">
							<div class="col-md-12">
								...
								<?php
								$sql_completadas = "SELECT * FROM appointment WHERE estado = 'completada'";
								...
								if ($result->num_rows > 0) {
									...
									while ($row = $result->fetch_assoc()) {
										...
										<td>" . $row['fecha_parada'] . "</td>
										<td>" . $row['fecha_funcion'] . "</td>
										<td>" . $row['tiempo_trabajo'] . " horas</td>
