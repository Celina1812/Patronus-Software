...
<head>
	<title>Patronus | Cambiar contraseña</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Mi cuenta | Cambiar contraseña</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Mi cuenta</span>
											...
											<div class="panel-body">
												...
												<form role="form" name="chngpwd" method="post" onSubmit="return valid();">
													<div class="form-group">
														...
														<input type="password" name="cpass" class="form-control" placeholder="Introducir contraseña actual">
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<input type="password" name="cfpass" class="form-control" placeholder="Confirmar nueva contraseña">
													</div>
