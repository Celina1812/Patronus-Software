...
<head>
	<title>Patronus | Editar perfil</title>
...
<body>
												...
												?>
													...
													<form role="form" name="adddoc" method="post" onSubmit="return valid();">
														<div class="form-group">
															...
															<input type="text" name="docname" class="form-control" value="<?php echo htmlentities($data['specilization']); ?>">
														</div>
	...
	<!--RECORDATORIO PHPMYADMIN
		ALTER TABLE `doctors`
		CHANGE COLUMN `specilization` `tipo_persona` VARCHAR(255);
